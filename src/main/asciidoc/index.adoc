...
operation::list-events[snippets='response-fields,curl-request,http-response,links']
...
operation::create-event[snippets='request-fields,curl-request,http-response,request-headers,response-headers,response-fields,links']
